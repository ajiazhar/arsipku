                    ...
                    while ($p = mysqli_fetch_array($user)) {
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- Modal Hapus -->
                                <div class="modal fade" id="exampleModal_<?php echo $p['user_id']; ?>" tabindex="-1"
                                ...
                                <div class="btn-group">
                                    <a href="user_edit.php?id=<?php echo $p['user_id']; ?>" class="btn btn-default"><i
                                            class="fa fa-wrench"></i></a>
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#exampleModal_<?php echo $p['user_id']; ?>">
