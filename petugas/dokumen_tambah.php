    ...
    <div class="panel panel">
        ...
        <div class="panel-body">
            ...
            <form action="dokumen_aksi.php" method="POST">
                ...
                <!-- Baris 1: Kode + Pencipta + Bidang + Tahun Arsip -->
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="arsip_nama" class="form-control" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Bidang</label>
                            <input type="text" name="arsip_bidang" class="form-control" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="tahun_arsip" class="form-control" placeholder="" required>
                        </div>
                    </div>
                </div>

                <!-- Baris 2: Sampul + Box + Rak + Jumlah -->
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Sampul</label>
                            <input type="text" name="arsip_sampul" class="form-control" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Box</label>
                            <input type="text" name="arsip_box" class="form-control" placeholder="" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Jumlah</label>
                            <input type="text" name="arsip_jumlah" class="form-control" placeholder="" required>
                        </div>
                    </div>
                </div>

                <!-- Baris 3: Index + Tingkat Perkembangan + Akses Surat -->
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Index</label>
