                    ...
                    <div class="panel panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="pull-right">
                                <a href="arsip.php" class="btn btn-sm btn-primary"><i class="fa fa-arrow-left"></i>
                                    Kembali</a>
                            </div>
                                ...
                                <form method="post" action="arsip_update.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                            name="deskripsi"><?= $d['arsip_deskripsi']; ?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="rak"
                                            value="<?php echo isset($d['arsip_rak']) ? $d['arsip_rak'] : ''; ?>"
                                            placeholder="Contoh: A2, B12, Rak-03" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                            name="keterangan"><?= $d['arsip_keterangan']; ?></textarea>
                                    </div>
