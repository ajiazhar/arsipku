                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="rak" required="required">
                                    ...
                                    while ($r = mysqli_fetch_array($rak)) {
                                        ?>
                                        <option <?php if ($r['rak_id'] == $d['arsip_rak']) {
                                            echo "selected='selected'";
                                        } ?> value="<?php echo $r['rak_id']; ?>">
                                            <?php echo $r['rak_nama']; ?>
                                        </option>
                                        <?php
                                    }
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="akses" required="required">
                                    ...
                                    while ($s = mysqli_fetch_array($akses)) {
                                        ?>
                                        <option <?php if ($s['akses_id'] == $d['surat_akses']) {
                                            echo "selected='selected'";
                                        } ?>
                                            value="<?php echo $s['akses_id']; ?>">
                                            <?php echo $s['akses_nama']; ?>
                                        </option>
                                        <?php
                                    }
                                    ?>
