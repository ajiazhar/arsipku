                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="single-cards-item">
                            ...
                            <div class="single-product-text">
                                ...
                                <h5>Petugas</h5>
                                <p class="ctn-cards">Pengelolaan arsip jadi lebih mudah dengan sistem informasi arsip
                                    digital.
                                </p>
                            </div>
                        </div>
                                ...
                                <form action="profil_act.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Masukkan Nama .."
                                            name="nama" required="required" value="<?php echo $s['petugas_nama'] ?>">
                                    </div>
